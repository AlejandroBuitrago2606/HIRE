    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <br />
                <p class="text-black mb-0">Los campos con <span class="text-danger">*</span> son obligatorios.</p>
                ...
                <div style="max-height: calc(100vh - 150px); overflow-y: auto">
                    ...
                    <div class="d-flex justify-content-center mb-5">
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <asp:Button ID="btnRegistrarEmpresa" Style="color: white; background-color: #10317a;" OnClick="btnRegistrarEmpresa_Click" CssClass="btn" runat="server" Text="Registrar" />
                            </ContentTemplate>
                        </asp:UpdatePanel>
